                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                        	<a href="
                                            <?php echo 'approval/edit_approval/'.$row->ID_REQUEST.'/1'; ?>
                                            " class="btn2 btn2-info btn2-mini">Ya</a>
                                            
                                            <a href="
                                            <?php echo 'approval/edit_approval/'.$row->ID_REQUEST.'/2'; ?>
                                            " class="btn2 btn2-danger btn2-mini">Tidak</a>
                                        </td>
                                    </tr>
                                    <?php }
										echo form_close();
