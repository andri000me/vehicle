      ...
      <center>	 
         ...
         <div id="header_pjbs">
             <div class="header_pjbs">
                 ...
                 <div class="panel50kn">
            	     <div class="login_pjbs">
                	     <div class="foto_login fright">
                    	     <img src="<?php echo base_url();?>asset/images/pjbs_logo.JPG" alt="foto Profil"> 
                         </div>  
                         <div class="fright stlog_pjbs">
                    	     <div> <?php echo $this->session->userdata('nama'); ?> </div>
                             <div>
                                 <!-- <a href="<?php //echo base_url(); ?>home/logout" class="btn lgt" data-toggle="modal" data-target="#myModal"> Logout </a> -->
								 <?php echo anchor('home/logout','Logout', array('class' => 'btn lgt')); ?> 
                             </div>
                         </div>
                     </div>
                     <div class="menu_pjbs">
                	     <ul>
                    	     <a href="<?php echo base_url(); ?>" class="active"><li>Home</li></a>
                             <?php 
                                   ...
                                   <li>                                                
                                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                       <tr>
                                         ...
                                         <td valign="middle"><img src="<?php echo base_url();?>asset/images/banner/14_20120730_14045288.png" alt="" /></td>
                                       </tr>
                                     </table>					
                                   </li>
                                   <li>                                                
                                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                       <tr>
                                         ...
                                         <td valign="middle"><img src="<?php echo base_url();?>asset/images/banner/13_20120730_14001783.png" alt="" /></td>
                                       </tr>
                                     </table>					
                                   </li>
                                   <li>                                                
                                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                         ...
                                         <td valign="middle"><img src="<?php echo base_url();?>asset/images/banner/12_20120730_13331811.png" alt="" /></td>
                                       </tr>
                                      </table>					
                                   </li>
                                 </ul>
