					  ...
					  <div class="clear"></div>
						...
						<div class="panel90">
                	       <div class="judul_pjbs">
							  ...
							  <?php 
					              echo anchor('master/insert_jabatan','Tambah Data', 
						   ...
						   <div class="row-fluid">
                             <div class="span12">
							    ...
							    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
								   <thead>
								      <tr>
										...
										<th width='20%'>SUBDIT</th>
										<th width='20%'>JENIS JABATAN</th>
										<th width='20%'>OPSI</th>
									  </tr>
								   </thead>
								   <tbody>
									  ...
									  <?php
										   ...
										   <tr>
											   ...
											   <td align='center'>
												   <?php
													   echo anchor('master/edit_jabatan/'.$row->ID_JABATAN, 'Edit', 'class="btn2 btn2-info btn2-mini"');
													   echo '  ';
													   echo anchor('master/delete_jabatan/'.$row->ID_JABATAN, 'Hapus', 'class="btn2 btn2-danger btn2-mini"');
												   ?>
											   </td>
										   </tr>
										   <?php
								...
								<?php echo anchor('master/subdit', 'Lihat Daftar Subdit.'); ?>
