          ...
          <div class="sprtr_1"></div>
			 ...
			 <div class="panel90">
                <div class="judul_pjbs">
                   <h3> Form Ubah Detail Kendaraan Dinas </h3>
                </div>
				...
				<div class="row-fluid">
				  ...
				  <?php 
				    $row = $detail_kd->row();
					echo form_open('master/edit_detail_kd/'.$row->ID_DETAIL_KENDARAAN_DINAS);
				  ?>
                         ...
                         <td>
						     <?php 
                                foreach($tipe_kd->result() as $row_tipe_kd)
                                 ...
                                 echo form_dropdown('id_tipe_kendaraan_dinas', $tipe_kd_list, $row->ID_TIPE_KENDARAAN_DINAS);
                         ...
                         <td>
						     <?php 
                                foreach($pengguna->result() as $row_pengguna)
                                 ...
                                 echo form_dropdown('id_pengguna', $pengguna_list, $row->ID_PENGGUNA);
                         ...
                         <td>
						     <?php 
                                foreach($lokasi->result() as $row_lokasi)
                                 ...
                                 echo form_dropdown('id_lokasi', $lokasi_list, $row->ID_LOKASI);
					   ...
					   <tr>
						...
						<td>
						   <?php
							  ...
							  $tgl_serah_terima = $tgl->format_tanggal2($row->TGL_SERAH_TERIMA);
						   
						      $data = array(
                                   'name'        => 'tgl_serah_terima',
                                   'id'          => 'inputDatepic',
								   'class'       => 'inputDatepic',
                                   'value'       => $tgl_serah_terima
                                   );
