    	     ...
    	     <div id="content_pjbs">
        	     <div class="content_pjbs">
					 ...
					 <div class="fleft" style="margin-left:10px;">
                        <table>
                              <tr>
                                  <td><?php echo anchor('report/kendaraan', 'Operasional Kendaraan', array('class' => 'btn2 btn2-small btn2-primary')); ?></td>
								  <td><?php echo anchor('report/detail_kendaraan', 'Detail Operasional Kendaraan', array('class' => 'btn2 btn2-small btn2-inverse')); ?></td>
                              </tr>
                          </table>
                      </div>
