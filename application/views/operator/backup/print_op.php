...
<body onLoad="window.print(); window.close();" background="<?php echo base_url();?>asset/images/C_.jpg" style="background-repeat:no-repeat">
<div id="main-content">
...
<table width="687" border="0">
  ...
  <tr>
    ...
    <td>:</td>
    <td colspan="4"><?php echo $row->JML_PENUMPANG; ?></td>
  </tr>
